...
tr = title.add_run("RDTII AutoExtract")
tr.bold = True
tr.font.size = Pt(18)
...
body(
    "RDTII AutoExtract is an open-source, model-agnostic AI pipeline that automates roughly "
    ...
    "stages: crawler-based document discovery with anti-bot handling and provenance "
...
body(
    ...
    "availability, anti-bot portals, and language coverage spanning English, Vietnamese, "
